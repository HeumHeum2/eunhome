...
public class DeviceWifiAdapter extends RecyclerView.Adapter<DeviceWifiAdapter.ViewHolder> {
    ...
    DeviceWifiAdapter(Context context, ArrayList<WifiData> list){
        this.context = context;
        this.scanDatas = list;
    }

    @Override
    public DeviceWifiAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        View view = inflater.inflate(R.layout.item_wifi, parent, false);
        DeviceWifiAdapter.ViewHolder viewHolder = new DeviceWifiAdapter.ViewHolder(view);
        return viewHolder;
    }
